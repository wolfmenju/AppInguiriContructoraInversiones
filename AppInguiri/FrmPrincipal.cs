...
namespace AppInguiri
{
    ...
    public partial class FrmPrincipal : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        FrmTipoOperacion frmTipoOperacion = null;
        ...
        private void barBtnObra_ItemClick(object sender, ItemClickEventArgs e)
        {
            pbLogoInguiri.Visible = false;
            frmObra = FrmObra.Instance();
            frmObra.MdiParent = this;
            frmObra.Show();
            VerificarFormulario(frmObra);
        }
        ...
        private void barBtnTipoOperacion_ItemClick(object sender, ItemClickEventArgs e)
        {
            pbLogoInguiri.Visible = false;
            frmTipoOperacion = FrmTipoOperacion.Instance();
            frmTipoOperacion.MdiParent = this;
            frmTipoOperacion.Show();
            VerificarFormulario(frmTipoOperacion);
        }
