...
namespace AppInguiri
{
    public partial class FrmObra : Form
    {
        ...
        private static FrmObra frmInstance = null;
        ...
        //Singleton
        public static FrmObra Instance()
        {
            if (((frmInstance == null) || (frmInstance.IsDisposed == true)))
            {
                frmInstance = new FrmObra();
            }
        ...
        private void Nuevo()
        {
            FrmObraActualiza frmObraActualiza = new FrmObraActualiza();
            frmObraActualiza.frmInventario = this;
            frmObraActualiza.ShowDialog();
            frmObraActualiza.Focus();
        }
