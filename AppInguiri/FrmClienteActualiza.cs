...
namespace AppInguiri
{
    public partial class FrmClienteActualiza : Form
    {
        ...
        public int tipo = 0;
        public FrmClienteListar frmClienteListar = null;
        ...
        private void CmdGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (tipo ==0)
            {
                if (frmCliente != null)
                {
                    if (!Funciones.DuplicadosDocumento(txtNumeroDoc.Text, frmCliente.DgvCliente))
                    {
                ...
                else if (frmClienteListar != null)
                {
                    if (!Funciones.DuplicadosDocumento(txtNumeroDoc.Text, frmClienteListar.DgvCliente))
                    {
                        txtRazonSocial.Clear();
                        txtRazonSocial.Focus();
                        cerrarFormulario = false;
        ...
        {
            chkValidaExterna.Checked = false;
            if (tipo == 0)
            {
